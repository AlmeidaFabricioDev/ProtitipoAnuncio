...
document.getElementById("botao_entrar").addEventListener("click", function() {
  // Obtém o elemento do menu dropdown
  var menuDropdown = document.getElementById("entrar");
...
function closeMenuDropdown(event) {
  ...
  if (event.target !== document.getElementById("botao_entrar") && !menuDropdown.contains(event.target)) {
      menuDropdown.style.display = "none";
